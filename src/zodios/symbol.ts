...
const AccountTypeEnum = z.union([
  z.literal(0),
  z.literal(1),
  z.literal(2),
  z.literal(3),
]);
const AccountLinkPublicKeyDTO = z
...
const AccountLinkVotingKeyDTO = z
  ...
  .passthrough();
const AccountLinkVotingKeysDTO = z
  .object({ publicKeys: z.array(AccountLinkVotingKeyDTO) })
  .passthrough();
...
const AccountDTO = z
  ...
  .passthrough();
const AccountInfoDTO = z
  .object({ id: z.string(), account: AccountDTO })
  .passthrough();
const Pagination = z
  .object({ pageNumber: z.number().int(), pageSize: z.number().int() })
  .passthrough();
const AccountPage = z
  .object({ data: z.array(AccountInfoDTO), pagination: Pagination })
  .passthrough();
const ModelError = z
...
const MerkleTreeBranchLinkDTO = z
  .object({ bit: z.string(), link: Hash256 })
  .passthrough();
...
const BlockInfoDTO = z
  ...
  .passthrough();
const BlockPage = z
  .object({ data: z.array(BlockInfoDTO), pagination: Pagination })
  .passthrough();
const PositionEnum = z.enum(["left", "right"]);
const MerklePathItemDTO = z
  .object({ position: PositionEnum, hash: Hash256 })
  .partial()
  .passthrough();
...
const ParentPublicKeySignaturePair = z
  .object({ parentPublicKey: PublicKey, signature: Signature })
  .passthrough();
...
const ChainPropertiesDTO = z
  ...
  .partial()
  .passthrough();
const AccountKeyLinkNetworkPropertiesDTO = z
  .object({ dummy: z.string() })
  .partial()
  .passthrough();
...
const SecretLockNetworkPropertiesDTO = z
  ...
  .partial()
  .passthrough();
const MetadataNetworkPropertiesDTO = z
  .object({ maxValueSize: z.string() })
  .partial()
  .passthrough();
...
const NamespaceNetworkPropertiesDTO = z
  ...
  .partial()
  .passthrough();
const AccountRestrictionNetworkPropertiesDTO = z
  .object({ maxAccountRestrictionValues: z.string() })
  .partial()
  .passthrough();
const MosaicRestrictionNetworkPropertiesDTO = z
  .object({ maxMosaicRestrictionValues: z.string() })
  .partial()
  .passthrough();
const TransferNetworkPropertiesDTO = z
  .object({ maxMessageSize: z.string() })
  .partial()
  .passthrough();
...
const NodeHealthDTO = z
  .object({ apiNode: NodeStatusEnum, db: NodeStatusEnum })
  .passthrough();
...
const StorageInfoDTO = z
  ...
  .passthrough();
const CommunicationTimestampsDTO = z
  .object({ sendTimestamp: Timestamp, receiveTimestamp: Timestamp })
  .partial()
  .passthrough();
const NodeTimeDTO = z
  .object({ communicationTimestamps: CommunicationTimestampsDTO })
  .passthrough();
...
const UnlockedAccountDTO = z
  .object({ unlockedAccount: z.array(PublicKey) })
  .passthrough();
const transactionPayload = z
  .object({ payload: z.string() })
  .partial()
  .passthrough();
const AnnounceTransactionInfoDTO = z
...
const TransactionBodyDTO = z
  .object({ maxFee: Amount, deadline: BlockDuration })
  .passthrough();
const TransactionDTO = SizePrefixedEntityDTO.and(VerifiableEntityDTO)
  .and(EntityDTO)
  .and(TransactionBodyDTO);
const LinkActionEnum = z.union([z.literal(0), z.literal(1)]);
const AccountKeyLinkTransactionBodyDTO = z
  .object({ linkedPublicKey: PublicKey, linkAction: LinkActionEnum })
  .passthrough();
const AccountKeyLinkTransactionDTO = TransactionDTO.and(
  AccountKeyLinkTransactionBodyDTO
);
const EmbeddedTransactionDTO = EntityDTO;
const EmbeddedAccountKeyLinkTransactionDTO = EmbeddedTransactionDTO.and(
  AccountKeyLinkTransactionBodyDTO
);
const NodeKeyLinkTransactionBodyDTO = z
  .object({ linkedPublicKey: PublicKey, linkAction: LinkActionEnum })
  .passthrough();
const NodeKeyLinkTransactionDTO = TransactionDTO.and(
  NodeKeyLinkTransactionBodyDTO
);
const EmbeddedNodeKeyLinkTransactionDTO = EmbeddedTransactionDTO.and(
  NodeKeyLinkTransactionBodyDTO
);
const VrfKeyLinkTransactionBodyDTO = z
  .object({ linkedPublicKey: PublicKey, linkAction: LinkActionEnum })
  .passthrough();
const VrfKeyLinkTransactionDTO = TransactionDTO.and(
  VrfKeyLinkTransactionBodyDTO
);
const EmbeddedVrfKeyLinkTransactionDTO = EmbeddedTransactionDTO.and(
  VrfKeyLinkTransactionBodyDTO
);
...
const VotingKeyLinkTransactionBodyDTO = z
  ...
  .passthrough();
const VotingKeyLinkTransactionDTO = TransactionDTO.and(
  VotingKeyLinkTransactionBodyDTO
);
const EmbeddedVotingKeyLinkTransactionDTO = EmbeddedTransactionDTO.and(
  VotingKeyLinkTransactionBodyDTO
);
const CosignatureVersion = z.string();
const CosignatureDTO = VerifiableEntityDTO.and(
  z
    .object({ version: CosignatureVersion, signerPublicKey: PublicKey })
    .passthrough()
);
const AggregateTransactionBodyDTO = z
  .object({ transactionsHash: Hash256, cosignatures: z.array(CosignatureDTO) })
  .passthrough();
...
const HashLockTransactionBodyDTO = z
  ...
  .passthrough();
const EmbeddedHashLockTransactionDTO = EmbeddedTransactionDTO.and(
  HashLockTransactionBodyDTO
);
const UnresolvedAddress = z.string();
const LockHashAlgorithmEnum_ = z.union([
  z.literal(0),
  z.literal(1),
  z.literal(2),
]);
const SecretLockTransactionBodyDTO = z
  ...
  .passthrough();
const EmbeddedSecretLockTransactionDTO = EmbeddedTransactionDTO.and(
...
const SecretProofTransactionBodyDTO = z
  ...
  .passthrough();
const EmbeddedSecretProofTransactionDTO = EmbeddedTransactionDTO.and(
...
const AccountMetadataTransactionBodyDTO = z
  ...
  .passthrough();
const EmbeddedAccountMetadataTransactionDTO = EmbeddedTransactionDTO.and(
...
const MosaicMetadataTransactionBodyDTO = z
  ...
  .passthrough();
const EmbeddedMosaicMetadataTransactionDTO = EmbeddedTransactionDTO.and(
...
const NamespaceMetadataTransactionBodyDTO = z
  ...
  .passthrough();
const EmbeddedNamespaceMetadataTransactionDTO = EmbeddedTransactionDTO.and(
...
const MosaicDefinitionTransactionBodyDTO = z
  ...
  .passthrough();
const EmbeddedMosaicDefinitionTransactionDTO = EmbeddedTransactionDTO.and(
...
const MosaicSupplyChangeTransactionBodyDTO = z
  ...
  .passthrough();
const EmbeddedMosaicSupplyChangeTransactionDTO = EmbeddedTransactionDTO.and(
...
const MosaicSupplyRevocationTransactionBodyDTO = z
  ...
  .passthrough();
const EmbeddedMosaicSupplyRevocationTransactionDTO = EmbeddedTransactionDTO.and(
...
const NamespaceRegistrationTransactionBodyDTO = z
  ...
  .passthrough();
const EmbeddedNamespaceRegistrationTransactionDTO = EmbeddedTransactionDTO.and(
...
const AddressAliasTransactionBodyDTO = z
  ...
  .passthrough();
const EmbeddedAddressAliasTransactionDTO = EmbeddedTransactionDTO.and(
...
const MosaicAliasTransactionBodyDTO = z
  ...
  .passthrough();
const EmbeddedMosaicAliasTransactionDTO = EmbeddedTransactionDTO.and(
...
const MultisigAccountModificationTransactionBodyDTO = z
  ...
  .passthrough();
const EmbeddedMultisigAccountModificationTransactionDTO =
  EmbeddedTransactionDTO.and(MultisigAccountModificationTransactionBodyDTO);
...
const AccountAddressRestrictionTransactionBodyDTO = z
  ...
  .passthrough();
const EmbeddedAccountAddressRestrictionTransactionDTO =
  EmbeddedTransactionDTO.and(AccountAddressRestrictionTransactionBodyDTO);
const AccountMosaicRestrictionTransactionBodyDTO = z
  ...
  .passthrough();
const EmbeddedAccountMosaicRestrictionTransactionDTO =
  EmbeddedTransactionDTO.and(AccountMosaicRestrictionTransactionBodyDTO);
const AccountOperationRestrictionTransactionBodyDTO = z
  ...
  .passthrough();
const EmbeddedAccountOperationRestrictionTransactionDTO =
  EmbeddedTransactionDTO.and(AccountOperationRestrictionTransactionBodyDTO);
...
const MosaicGlobalRestrictionTransactionBodyDTO = z
  ...
  .passthrough();
const EmbeddedMosaicGlobalRestrictionTransactionDTO =
  EmbeddedTransactionDTO.and(MosaicGlobalRestrictionTransactionBodyDTO);
const MosaicAddressRestrictionTransactionBodyDTO = z
  ...
  .passthrough();
const EmbeddedMosaicAddressRestrictionTransactionDTO =
  EmbeddedTransactionDTO.and(MosaicAddressRestrictionTransactionBodyDTO);
const UnresolvedMosaic = z
  .object({ id: UnresolvedMosaicId, amount: Amount })
  .passthrough();
const TransferTransactionBodyDTO = z
  ...
  .passthrough();
const EmbeddedTransferTransactionDTO = EmbeddedTransactionDTO.and(
...
const EmbeddedTransactionInfoDTO = z
  ...
  .passthrough();
const EmbeddedTransactionBodyDTO = z
  .object({ transactions: z.array(EmbeddedTransactionInfoDTO) })
  .passthrough();
const AggregateTransactionBodyExtendedDTO = AggregateTransactionBodyDTO.and(
  EmbeddedTransactionBodyDTO
);
const AggregateTransactionExtendedDTO = TransactionDTO.and(
  AggregateTransactionBodyExtendedDTO
);
const HashLockTransactionDTO = TransactionDTO.and(HashLockTransactionBodyDTO);
const SecretLockTransactionDTO = TransactionDTO.and(
  SecretLockTransactionBodyDTO
);
const SecretProofTransactionDTO = TransactionDTO.and(
  SecretProofTransactionBodyDTO
);
const AccountMetadataTransactionDTO = TransactionDTO.and(
  AccountMetadataTransactionBodyDTO
);
const MosaicMetadataTransactionDTO = TransactionDTO.and(
  MosaicMetadataTransactionBodyDTO
);
const NamespaceMetadataTransactionDTO = TransactionDTO.and(
  NamespaceMetadataTransactionBodyDTO
);
const MosaicDefinitionTransactionDTO = TransactionDTO.and(
  MosaicDefinitionTransactionBodyDTO
);
const MosaicSupplyChangeTransactionDTO = TransactionDTO.and(
  MosaicSupplyChangeTransactionBodyDTO
);
const MosaicSupplyRevocationTransactionDTO = TransactionDTO.and(
  MosaicSupplyRevocationTransactionBodyDTO
);
const NamespaceRegistrationTransactionDTO = TransactionDTO.and(
  NamespaceRegistrationTransactionBodyDTO
);
const AddressAliasTransactionDTO = TransactionDTO.and(
  AddressAliasTransactionBodyDTO
);
const MosaicAliasTransactionDTO = TransactionDTO.and(
  MosaicAliasTransactionBodyDTO
);
const MultisigAccountModificationTransactionDTO = TransactionDTO.and(
  MultisigAccountModificationTransactionBodyDTO
);
const AccountAddressRestrictionTransactionDTO = TransactionDTO.and(
  AccountAddressRestrictionTransactionBodyDTO
);
const AccountMosaicRestrictionTransactionDTO = TransactionDTO.and(
  AccountMosaicRestrictionTransactionBodyDTO
);
const AccountOperationRestrictionTransactionDTO = TransactionDTO.and(
  AccountOperationRestrictionTransactionBodyDTO
);
const MosaicGlobalRestrictionTransactionDTO = TransactionDTO.and(
  MosaicGlobalRestrictionTransactionBodyDTO
);
const MosaicAddressRestrictionTransactionDTO = TransactionDTO.and(
...
const TransactionPage = z
  .object({ data: z.array(TransactionInfoDTO), pagination: Pagination })
  .passthrough();
...
const transactionHashes = z
  ...
  .partial()
  .passthrough();
const TransactionGroupEnum = z.enum([
  "unconfirmed",
  "confirmed",
  "failed",
  "partial",
...
const HashLockEntryDTO = z
  ...
  .passthrough();
const HashLockInfoDTO = z
  .object({ id: z.string(), lock: HashLockEntryDTO })
  .passthrough();
const HashLockPage = z
  .object({ data: z.array(HashLockInfoDTO), pagination: Pagination })
  .passthrough();
...
const SecretLockEntryDTO = z
  ...
  .passthrough();
const SecretLockInfoDTO = z
  .object({ id: z.string(), lock: SecretLockEntryDTO })
  .passthrough();
const SecretLockPage = z
  .object({ data: z.array(SecretLockInfoDTO), pagination: Pagination })
  .passthrough();
...
const MetadataEntryDTO = z
  ...
  .passthrough();
const MetadataInfoDTO = z
  .object({ id: z.string(), metadataEntry: MetadataEntryDTO })
  .passthrough();
const MetadataPage = z
  .object({ data: z.array(MetadataInfoDTO), pagination: Pagination })
  .passthrough();
const MosaicDTO = z
  .object({
    version: StateVersion.int(),
  ...
  .passthrough();
const MosaicInfoDTO = z
  .object({ id: z.string(), mosaic: MosaicDTO })
  .passthrough();
const MosaicPage = z
  .object({ data: z.array(MosaicInfoDTO), pagination: Pagination })
  .passthrough();
const mosaicIds = z
...
const MultisigDTO = z
  ...
  .passthrough();
const MultisigAccountInfoDTO = z
  .object({ multisig: MultisigDTO })
  .passthrough();
const MultisigAccountGraphInfoDTO = z
  ...
  .passthrough();
const NamespaceMetaDTO = z
  .object({ active: z.boolean(), index: z.number().int() })
  .passthrough();
...
const NamespaceDTO = z
  ...
  .passthrough();
const NamespaceInfoDTO = z
  .object({ id: z.string(), meta: NamespaceMetaDTO, namespace: NamespaceDTO })
  .passthrough();
const NamespacePage = z
  .object({ data: z.array(NamespaceInfoDTO), pagination: Pagination })
  .passthrough();
...
const addresses = z
  ...
  .partial()
  .passthrough();
const AccountNamesDTO = z
  .object({ address: Address, names: z.array(z.string()) })
  .passthrough();
const AccountsNamesDTO = z
  .object({ accountNames: z.array(AccountNamesDTO) })
  .passthrough();
const MosaicNamesDTO = z
  .object({ mosaicId: MosaicId, names: z.array(z.string()) })
  .passthrough();
const MosaicsNamesDTO = z
  .object({ mosaicNames: z.array(MosaicNamesDTO) })
  .passthrough();
...
const SourceDTO = z
  .object({ primaryId: UInt32.int(), secondaryId: UInt32.int() })
  .passthrough();
const ReceiptDTO = z
  .object({ version: z.number().int(), type: ReceiptTypeEnum })
  .passthrough();
...
const BalanceChangeReceiptDTO = ReceiptDTO.and(
  z
    .object({ mosaicId: MosaicId, amount: Amount, targetAddress: Address })
    .passthrough()
);
const NamespaceExpiryReceiptDTO = ReceiptDTO.and(
  z.object({ artifactId: NamespaceId }).passthrough()
);
const MosaicExpiryReceiptDTO = ReceiptDTO.and(
  z.object({ artifactId: MosaicId }).passthrough()
);
const InflationReceiptDTO = ReceiptDTO.and(
  z.object({ mosaicId: MosaicId, amount: Amount }).passthrough()
);
...
const TransactionStatementPage = z
  ...
  .passthrough();
const ResolutionEntryDTO = z
  .object({ source: SourceDTO, resolved: z.union([Address, MosaicId]) })
  .passthrough();
...
const ResolutionStatementInfoDTO = z
  ...
  .passthrough();
const ResolutionStatementPage = z
  .object({ data: z.array(ResolutionStatementInfoDTO), pagination: Pagination })
  .passthrough();
const AccountRestrictionDTO = z
  .object({
    restrictionFlags: AccountRestrictionFlagsEnum,
    values: z.array(
      z.union([UnresolvedAddress, UnresolvedMosaicId, TransactionTypeEnum])
    ),
  })
  .passthrough();
const AccountRestrictionsDTO = z
  ...
  .passthrough();
const AccountRestrictionsInfoDTO = z
  .object({ accountRestrictions: AccountRestrictionsDTO })
  .passthrough();
const AccountRestrictionsPage = z
  .object({ data: z.array(AccountRestrictionsInfoDTO), pagination: Pagination })
  .passthrough();
const MosaicRestrictionEntryTypeEnum = z.union([z.literal(0), z.literal(1)]);
const MosaicAddressRestrictionEntryDTO = z
  .object({ key: RestrictionKey, value: z.string() })
  .passthrough();
...
const MosaicRestrictionsPage = z
  .object({
    data: z.array(
      z.union([MosaicAddressRestrictionDTO, MosaicGlobalRestrictionDTO])
    ),
    pagination: Pagination,
  })
  .passthrough();
const MosaicRestrictionDTO = z.union([
